...
from My_Budget.functions.expanses import input_id, get_total, get_expanse, plot_exp_month, plot_all, isempty
...
def show_entries():
    ...
    if nodata:
        return render_template('show_entries.html', nodata=nodata)
    else:
        ...
        if request.method == "GET":
            print("get")
            account_val = "Courant"
            date_val = month_year[:-3]
        elif request.method == "POST":
            print("post")
            account_val = request.form["account"]
            date_val = request.form["bdaymonth"]
        ...
        return render_template('show_entries.html', nodata=nodata, graphJSON=graphJSON, data=data,
                                ...
                                solde=solde, accounts=accounts, account_val=account_val,
                                date_val=date_val)
